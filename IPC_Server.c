...
int main(void)
{
    ...
    int shm_id = shmget(IPC_PRIVATE,sizeof(Whiteboard)+maxUsers*sizeof(User) +
    maxTopics*(sizeof(Topic)+sizeof(User)*maxSubscribers+ sizeof(Message)*maxMessages),0666|IPC_CREAT);
